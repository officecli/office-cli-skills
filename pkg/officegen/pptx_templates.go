...
// XML 模板常量 - OOXML PPTX 格式所需的静态文件
// 移植自 drive-be/app/svc-ai/pkg/service/pptx/templates.go
...
// themeXML 已迁移到 theme.go 中的 officeThemeXML，三种格式共用
...
// ===== 图表辅助文件模板（严格匹配 chart-demo 格式）=====

// chartStyleXMLPie 饼图的 chart style（对应 chart-demo/style1.xml, id=251）
...
// chartStyleXMLDefault 折线图/柱状图的 chart style（对应 chart-demo/style2.xml, id=227）
...
// chartColorsXML 图表颜色方案（对应 chart-demo/colors1.xml，所有图表类型共用）
