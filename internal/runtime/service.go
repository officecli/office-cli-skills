...
func buildProjectPlanDeck(slides []officegen.Slide, deckTitle string) []officegen.Slide {
	...
	out := []officegen.Slide{
		...
		},
		{
			...
			SectionIndex:  1,
			SectionTitle:  "Readiness",
			Subtitle:      "Each status maps to one management response.",
		...
		},
		{
			...
			SectionIndex:  2,
			SectionTitle:  "Execution and Decisions",
			Subtitle:      "Each phase ends with a named gate.",
			Sections: normalizeSections([]officegen.SlideSection{
				{Heading: "T-8 to T-6", Detail: "Lock scope and owners"},
				{Heading: "T-5 to T-3", Detail: "Finish QA and enablement"},
				{Heading: "T-2 to Launch", Detail: "Confirm rollback path"},
			}, 3),
		},
		{
			Title:         "Escalation Path",
			Layout:        "content",
			Variant:       "bullets-band",
			NarrativeRole: "analysis",
			SectionIndex:  2,
			SectionTitle:  "Execution and Decisions",
			Subtitle:      "Keep every red item tied to an owner and timer.",
			Points: []string{
				"Trigger: red scope, quality, or readiness.",
				"Response: one DRI and 24-hour mitigation.",
