...
const routeSEO: Record<string, RouteSEO> = {
  ...
  '/free-quotas': buildRouteSEO('/free-quotas', 'OfficeCLI Admin | Free Trial Devices', 'Inspect legacy daily anonymous free-trial audit rows for OfficeCLI; current license state lives in free_quotas.'),
