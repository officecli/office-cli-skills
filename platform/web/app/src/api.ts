...
export const api = {
  ...
  reconcileOrder: (payload: { checkout_session_id: string }) => request<{ order: Order; awaiting_confirmation: boolean }>('/api/app/orders/reconcile', { method: 'POST', body: JSON.stringify(payload) }),
