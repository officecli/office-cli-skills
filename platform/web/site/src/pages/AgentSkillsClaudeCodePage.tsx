...
const claudeInstallCommand = '/plugin marketplace add officecli/officecli-skills\n/plugin install officecli@officecli-skills'
  ...
  return (
    <main className="overflow-x-hidden px-8 pt-24 pb-18 md:px-16 md:pt-28 md:pb-24">
      <div className="mx-auto max-w-[1440px]">
        <AgentSkillsBreadcrumbs items={getAgentSkillsBreadcrumbs('/officecli-skills/claude-code')} />
        <section className="rounded-[36px] border border-outline-variant/10 bg-surface-low px-8 py-10 shadow-[0_24px_70px_rgba(0,0,0,0.24)] md:px-10">
          ...
          <p className="mt-5 max-w-4xl text-lg leading-relaxed text-outline-variant">
            This page exists for the query pattern where people search for a Claude Code Office plugin and should land directly on the marketplace install flow for `officecli-skills`, not on an unrelated raw file page.
          </p>
          <div className="mt-8">
            <AgentSkillsSecondaryNav currentPath="/officecli-skills/claude-code" />
          </div>
        </section>
        ...
        <section className="mt-10 grid gap-6 lg:grid-cols-[minmax(0,1fr)_minmax(0,1fr)]">
          <article className="rounded-3xl border border-outline-variant/10 bg-surface-low p-6">
            ...
            <p className="mt-4 text-sm leading-relaxed text-outline-variant">
              Use the public `officecli/officecli-skills` marketplace repository when Claude Code should discover the OfficeCLI plugin through the normal plugin flow.
            </p>
            <div className="mt-6">
