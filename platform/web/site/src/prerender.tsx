...
export function renderRouteApp(pathname: string) {
  ...
  return compact([
    ...
    '        </div>',
    '        <div class="relative rounded-3xl border border-primary/15 bg-surface-low p-3 md:p-4 flex items-center justify-center min-h-0 overflow-hidden"><img src="/vibeofficing.png?v=1" alt="OfficeDex — AI-Native VibeOfficing platform. VibeCoding (Claude, Codex) is to developers what VibeOfficing (OfficeDex) is to office users." loading="lazy" class="max-h-full max-w-full w-auto h-auto object-contain rounded-2xl" /></div>',
    '      </div>',
    '    </section>',
