...
export function renderRouteApp(pathname: string) {
  ...
  return compact([
    ...
    '        </div>',
    '        <div class="relative rounded-3xl border border-primary/15 bg-surface-low p-3 md:p-4 overflow-hidden lg:min-h-0"><img src="/vibeofficing.png?v=1" alt="OfficeDex — AI-Native VibeOfficing platform. VibeCoding (Claude, Codex) is to developers what VibeOfficing (OfficeDex) is to office users." loading="lazy" class="block w-full h-auto rounded-2xl lg:absolute lg:inset-4 lg:w-[calc(100%-2rem)] lg:h-[calc(100%-2rem)] lg:object-contain" /></div>',
    '      </div>',
    '    </section>',
