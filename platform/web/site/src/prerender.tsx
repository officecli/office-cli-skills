...
export function renderRouteApp(pathname: string) {
  ...
  return compact([
    ...
    '        <div class="z-10">',
    '          <span class="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#0d4c54]/40 text-[#8af3f7] text-xs font-headline uppercase tracking-widest mb-6 border border-[#0d4c54]/60">Local-first AI document CLI · One-command online publish</span>',
