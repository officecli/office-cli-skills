...
export function renderRouteApp(pathname: string) {
  ...
  return compact([
    ...
    '      </div>',
    '      <p class="text-outline-variant text-lg max-w-3xl mt-4 leading-relaxed">Run officecli new pptx from scripts; just officecli to enter the interactive terminal—same binary. For non-terminal users, the officedex desktop app is on the way.</p>',
    '      <p class="text-outline-variant text-base max-w-3xl mt-3 leading-relaxed">Pick a surface: officedex desktop app (coming soon), officecli-tui interactive terminal (run <code>officecli</code> to enter), or officecli scriptable command line (<code>officecli new &lt;format&gt;</code> from scripts). All three share the same generation engine.</p>',
    '    </section>',
